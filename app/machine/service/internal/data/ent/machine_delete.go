...
func (md *MachineDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, MachineMutation](ctx, md.sqlExec, md.mutation, md.hooks)
}
...
func (md *MachineDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(machine.Table, sqlgraph.NewFieldSpec(machine.FieldID, field.TypeUUID))
