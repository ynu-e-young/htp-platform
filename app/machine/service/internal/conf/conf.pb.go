...
type Data struct {
	...
	Oss      *Data_Oss      `protobuf:"bytes,2,opt,name=oss,proto3" json:"oss,omitempty"`
	Images   *Data_Images   `protobuf:"bytes,3,opt,name=images,proto3" json:"images,omitempty"`
}
...
func (x *Data) GetImages() *Data_Images {
	if x != nil {
		return x.Images
	}
	return nil
...
func (x *Data_Images) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Images) ProtoMessage() {}

func (x *Data_Images) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Images.ProtoReflect.Descriptor instead.
func (*Data_Images) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Data_Images) GetDir() string {
	if x != nil {
		return x.Dir
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xf6, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x12, 0x26, 0x0a, 0x03, 0x6f, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e,
	0x4f, 0x73, 0x73, 0x52, 0x03, 0x6f, 0x73, 0x73, 0x12, 0x2f, 0x0a, 0x06, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f,
	0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65,
	0x73, 0x52, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x1a, 0x0a, 0x06, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x12,
	0x10, 0x0a, 0x03, 0x64, 0x69, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69,
	0x72, 0x1a, 0x85, 0x01, 0x0a, 0x03, 0x4f, 0x73, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64,
	...
	0x09, 0x52, 0x06, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x7b, 0x0a, 0x08, 0x52, 0x65, 0x67,
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x42, 0x24, 0x5a, 0x22, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Images)(nil),         // 7: kratos.api.Data.Images
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 5: kratos.api.Data.oss:type_name -> kratos.api.Data.Oss
	7,  // 6: kratos.api.Data.images:type_name -> kratos.api.Data.Images
