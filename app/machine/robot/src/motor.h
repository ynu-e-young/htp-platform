...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_SRC_MOTOR_H_
#define HTP_PLATFORM_MACHINE_ROBOT_SRC_MOTOR_H_

#include <vector>

#include "motor_serial_comm.h"
#include "robot/data/motor/config/path.h"
#include "robot/data/motor/config/status_reg.h"
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_SRC_MOTOR_H_
