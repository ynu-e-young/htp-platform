...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_SRC_CONF_CONFIG_H_
#define HTP_PLATFORM_MACHINE_ROBOT_SRC_CONF_CONFIG_H_
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_SRC_CONF_CONFIG_H_
