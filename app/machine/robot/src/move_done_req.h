...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_SRC_MOVE_DONE_REQ_H_
#define HTP_PLATFORM_MACHINE_ROBOT_SRC_MOVE_DONE_REQ_H_
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_SRC_MOVE_DONE_REQ_H_
