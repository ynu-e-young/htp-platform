...
#ifndef GOOGLE_PROTOBUF_INCLUDED_include_2fconf_2fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_include_2fconf_2fconf_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_include_2fconf_2fconf_2eproto
...
struct TableStruct_include_2fconf_2fconf_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_include_2fconf_2fconf_2eproto;
namespace config {
class Bootstrap;
...
class Bootstrap final :
 ...
 private:
  ...
  friend struct ::TableStruct_include_2fconf_2fconf_2eproto;
};
// -------------------------------------------------------------------
...
class Local_GRPC final :
 ...
 public:
  ...
  ~Local_GRPC() override;
  explicit constexpr Local_GRPC(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Local final :
 ...
 public:
  ...
  ~Local() override;
  explicit constexpr Local(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Serial final :
 ...
 public:
  ...
  ~Serial() override;
  explicit constexpr Serial(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PlatInfo_InternalArray final :
 ...
 public:
  ...
  explicit constexpr PlatInfo_InternalArray(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PlatInfo final :
 ...
 public:
  ...
  ~PlatInfo() override;
  explicit constexpr PlatInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Bootstrap::set_allocated_local(::config::Local* local) {
  ...
  if (local) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::config::Local>::GetOwningArena(local);
    if (message_arena != submessage_arena) {
...
inline bool Bootstrap::_internal_has_serial() const {
  return this != internal_default_instance() && serial_ != nullptr;
}
...
inline void Bootstrap::unsafe_arena_set_allocated_serial(
    ::config::Serial* serial) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(serial_);
  }
  serial_ = serial;
  if (serial) {
...
inline void Bootstrap::set_allocated_serial(::config::Serial* serial) {
  ...
  if (serial) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::config::Serial>::GetOwningArena(serial);
    if (message_arena != submessage_arena) {
...
inline const ::config::Local_GRPC& Local::_internal_grpc() const {
  const ::config::Local_GRPC* p = grpc_;
...
inline void Local::set_allocated_grpc(::config::Local_GRPC* grpc) {
  ...
  if (grpc) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::config::Local_GRPC>::GetOwningArena(grpc);
    if (message_arena != submessage_arena) {
      grpc = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, grpc, submessage_arena);
    }
...
void Serial::set_serial_port(ArgT0&& arg0, ArgT... args) {
 ...
 serial_port_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Serial::_internal_set_serial_port(const std::string& value) {
  ...
  serial_port_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Serial::_internal_mutable_serial_port() {
  
  return serial_port_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Serial::release_serial_port() {
  // @@protoc_insertion_point(field_release:config.Serial.serial_port)
  return serial_port_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Serial::set_allocated_serial_port(std::string* serial_port) {
  ...
  serial_port_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serial_port,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (serial_port_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_include_2fconf_2fconf_2eproto
