...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_LOGGER_H_
#define HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_LOGGER_H_
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_LOGGER_H_
