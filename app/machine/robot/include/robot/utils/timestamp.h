...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_TIMESTAMP_H_
#define HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_TIMESTAMP_H_
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_INCLUDE_ROBOT_UTILS_TIMESTAMP_H_
