...
#ifndef HTP_PLATFORM_MACHINE_ROBOT_ROBOT_INTERNAL_CONF_BASIC_SETTING_H_
#define HTP_PLATFORM_MACHINE_ROBOT_ROBOT_INTERNAL_CONF_BASIC_SETTING_H_
...
#endif //HTP_PLATFORM_MACHINE_ROBOT_ROBOT_INTERNAL_CONF_BASIC_SETTING_H_
