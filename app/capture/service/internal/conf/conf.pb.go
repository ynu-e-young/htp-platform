...
type Data struct {
	...
	Capture *Data_Capture `protobuf:"bytes,1,opt,name=capture,proto3" json:"capture,omitempty"`
}
...
func (x *Data) GetCapture() *Data_Capture {
	if x != nil {
		return x.Capture
	}
	return nil
...
func (x *Data_Capture) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Capture) ProtoMessage() {}

func (x *Data_Capture) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Capture.ProtoReflect.Descriptor instead.
func (*Data_Capture) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Data_Capture) GetDevices() []int64 {
	if x != nil {
		return x.Devices
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0x5f, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x32, 0x0a, 0x07, 0x63, 0x61, 0x70, 0x74,
	0x75, 0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74,
	0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x43, 0x61, 0x70, 0x74,
	0x75, 0x72, 0x65, 0x52, 0x07, 0x63, 0x61, 0x70, 0x74, 0x75, 0x72, 0x65, 0x1a, 0x23, 0x0a, 0x07,
	0x43, 0x61, 0x70, 0x74, 0x75, 0x72, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x42, 0x24,
	0x5a, 0x22, 0x63, 0x61, 0x70, 0x74, 0x75, 0x72, 0x65, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Capture)(nil),        // 6: kratos.api.Data.Capture
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6, // 4: kratos.api.Data.capture:type_name -> kratos.api.Data.Capture
